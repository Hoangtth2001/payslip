...
import { getAllPaySlip } from 'redux/slice/payslip.sice';
...
export const Favourite: React.FC = () => {
  ...
  const handleOnclickStaff = async (id: string) => {
    await dispatch(getAllPaySlip(id));
  };
                ...
                <View key={index} style={styles.tableHead}>
                  ...
                  >
                    <Button
                      ...
                      onPress={() => {
                        handleOnclickStaff(item.employeeId);
                        push(PATH.PAYSLIP);
                      }}
                    >
